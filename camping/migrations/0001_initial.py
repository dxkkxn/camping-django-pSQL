    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=30)),
                ('id_profil', models.ForeignKey(db_column='id_profil', on_delete=django.db.models.deletion.CASCADE, to='camping.profil')),
                ('num_client', models.ForeignKey(db_column='num_client', on_delete=django.db.models.deletion.CASCADE, to='camping.client')),
                ...
                ('points_fidelite', models.ForeignKey(db_column='points_fidelite', on_delete=django.db.models.deletion.CASCADE, to='camping.fidelite')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom_service', models.ForeignKey(db_column='nom_service', on_delete=django.db.models.deletion.CASCADE, to='camping.servicesproposes')),
                ('num_reservation', models.ForeignKey(db_column='num_reservation', on_delete=django.db.models.deletion.CASCADE, to='camping.reservation')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='option_location', on_delete=django.db.models.deletion.CASCADE, to='camping.optionlocation'),
        ),
        migrations.AddField(
            model_name='reservation',
        ...
        migrations.AddConstraint(
            model_name='profil',
            constraint=models.CheckConstraint(check=models.Q(date_de_naissance__lte=datetime.date(2002, 12, 16)), name='age18ans'),
        ),
        migrations.AddConstraint(
            model_name='profil',
